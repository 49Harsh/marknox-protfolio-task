...
const About = () => {
  ...
  return (
    <section ref={ref} id="about" className="py-20 bg-blac">
          ...
          >
            <div className="w-64 h-64 mx-auto rounded-full">
              <img
                ...
                alt='webimage'
                loading='lazy'
                width={256}  // Adjusted to match the container size
                height={256} // Adjusted to match the container size
                className="rounded-full" // To maintain the circular shape
              />
            </div>
          </motion.div>
          <motion.div
